...
if(isset($_POST['reset-pass']))
{
    ...
    if($stmt->num_rows() > 0)
    {
        ...
        if ($stmt->execute()) {
            ...
            header('location: /reset-password?error_message=System Error Try Again');
        }
    }else{
        header('location: /reset-password?error_message=Your E-Mail Not Registered In This Platform');
    }
}
                        ...
                        <tr>
                            <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                                ...
                                <div style="line-height: 35px">
                                    ...
                                    Password reset request <span style="color: #6fcf20;"></span>
                                ...
                                <table border="0" width="400" align="center" cellpadding="0" cellspacing="0" class="container590">
                                    <tr>
                                        <td align="center" style="color: #888888; font-size: 16px; font-family: "Work Sans", Calibri, sans-serif; line-height: 24px;">
                                            ...
                                            <span style=" font-size:35px; color:#75e436; font-wright:900; font-family: Impact, Haettenschweiler, sans-serif;">Your new password</span>



                                            <br><br>New Password : ' .$password. '
    
                                            <br><br>Please Dont share this code with others.
                                            </div>
                                        </td>
                                    </tr>
                                </table>
