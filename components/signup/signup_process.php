...
if(isset($_POST['signup_btn']))
{
    ...
    if(!$domain_validation == 0)
    {
        ...
        if($stmt->num_rows() > 0)
        {    
            header('location: /signup?error_message=Your Email  Account already register on System');
        ...
        $insert_query = "INSERT INTO Users (FULL_NAME,unique_id,USER_NAME,USER_TYPE,PASSWORD_S,EMAIL,IMAGE,FACEBOOK,WHATSAPP,BIO,FALLOWERS,FALLOWING,POSTS) VALUES
        
        ('$full_name', '$unique_id', '$user_name', '$user_type', '$encrypted_password', '$email_address', '$image', '$facebook', '$whatsapp', '$bio', $fallowers, $fallowing, $post_count);";
        ...
        if($stmt->execute())
        {
            ...
            header("location: /signup?error_message=error occurred #008");
    ...
    {
        header("location: /signup?error_message=Please use verified mail like gmail & hotmail");

        exit;
    }
}else
{
    header("location: /signup?error_message=error occurred #009");
...
{    
    $acceptedDomains = array('gmail.com', 'hotmail.com', 'outlook.com');
...
function mailer($sending_address, $password, $user_name, $full_name)
{
    ...
    <head>
        ...
        <title>Amar World Registration</title>
                        ...
                        <tr>
                            <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                                ...
                                <div style="line-height: 35px">
                                    ...
                                    Thanks For Registering In <span style="color: #6fcf20;">Amar World</span>
                                    <img src="https://i.ibb.co/6gDhHsP/eaddsd.png" height="auto" style="max-height: 15vh;height:auto;margin-top:20px;">
                                ...
                                <table border="0" width="400" align="center" cellpadding="0" cellspacing="0" class="container590">
                                    <tr>
                                        <td align="center" style="color: #888888; font-size: 16px; font-family: "Work Sans", Calibri, sans-serif; line-height: 24px;">
                                            ...
                                            <span style=" font-size:35px; color:#75e436; font-wright:900; font-family: Impact, Haettenschweiler, sans-serif;">Login Details</span>



                                            <br><br>Username :'. $user_name . '
                                            <br><br>Password : ' .$password.
    
                                             '
    
                                            <br><br>Please Dont share login details with others & Make sure to change your password when you log In first time.
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td align="center" style="color: #ffffff; font-size: 14px; font-family: "Work Sans", Calibri, sans-serif; line-height: 26px;">
                                            ...
                                            <div style="line-height: 26px;">
                                                <a href="https://amarworld.me/login" style="color: #ffffff; text-decoration: none; border:">Log In</a>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="left" style="color: #888888; font-size: 14px; font-family: , Calibri, sans-serif; line-height: 23px;" class="text_color">
                                            <div style="color: #333333; font-size: 14px; font-family:  Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                ...
                                                Email us: <br/> <a href="mailto:support@amarworld.me" style="color: #888888; font-size: 14px; font-family: , Calibri, Sans-serif; font-weight: 400;">support@amarworld.me</a>
