...
if(isset($_POST['posting']))
{
    ...
    $folder = "./../../storage/posts/" . $file_complete;
    ...
    if($stmt->execute())
    {
        ...
        header("location: /upload?success_message=Post Successfully updated");
    ...
    {
        header("location: /upload?error_message=Error Occurred, try again - ERROR #008");
...
{
    header("location: /upload?error_message=Error Occurred, try again2 - ERROR #009");
