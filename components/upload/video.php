...
if(isset($_POST['posting']))
{
    ...
    $folder = "./../../storage/videos/" . $file_complete;

    $second_file = "./../storage/videos/" . $thumbnail_name_complete;
    ...
    if($stmt->execute())
    {
        ...
        header("location: /videoupload?success_message=Post Successfully updated");

        exit;
    }
    else
    {
        header("location: /videoupload?error_message=Error Occurred, try again - ERROR #008");
...
{
    header("location: /videoupload?error_message=Error Occurred, try again2 - ERROR #009");
