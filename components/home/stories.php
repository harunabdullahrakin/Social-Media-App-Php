...
include('get_following.php');?>
    ...
    <?php foreach($Clubs as $person){?>
            ...
            <form method="post" action="/follows" id="quick_access<?php echo $person['User_ID'];?>">
                ...
                <div class="status-card">
                    ...
                    <div class="profile-pic" style="cursor: pointer;">
                        <img onclick="document.getElementById('quick_access'+<?php echo $person['User_ID'];?>).submit();" src="<?php echo "/storage/pfp/".$person['IMAGE']?>" name="quick_access">
                    </div>
