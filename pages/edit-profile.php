        ...
        <div class="account-settings">
          ...
          <div class="user-profile-edit">
            ...
            <div class="user-avatar">
              ...
              <img src="<?php echo "../storage/pfp/".$_SESSION['img_path'] ?>" alt="profile-avatar">
...
<form method="POST" action="/components/profile/update-profile.php" enctype="multipart/form-data">
    <div class="card-body">
...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
  ...
  <h6 class="mb-2 text-primary">Your Details</h6>
...
<div class="mb-3">
  ...
  <label for="exampleFormControlTextarea1" class="form-label" style="padding-top: 5px;">Description</label>
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body">
              <form method="post" action="/components/profile/Update-Profile-img.php" enctype="multipart/form-data">
                  <div class="mb-3">
...
<div class="modal fade" id="passchange" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body">
              <form method="post" action="/components/profile/Change-Pass.php">
