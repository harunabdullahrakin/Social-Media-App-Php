            ...
            foreach($post_array as $post)
            {
                ...
                <div class="post">
                    ...
                    <video
                            ...
                            preload="none"
                            data-setup="{}"
                            poster="<?php echo '/storage/videos/'. $post['Thumbnail_Path']; ?>"
                    >
                        <source src="<?php echo '/storage/videos/'.$post['Video_Path'];?>" type="video/mp4" />
                        <p class="vjs-no-js">
...
<script type="text/javascript">
    ...
    function comment(){
        ...
        $.ajax({
            type:"post",
            url:"/components/shorts/comments_actionVid.php",
            data:
                {
                    'post_id' :post_id,
