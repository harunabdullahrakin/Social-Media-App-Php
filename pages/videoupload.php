  ...
  <div class="row">
    ...
    <div class="col">
      ...
      <div class="mb-5" >
        ...
        <form action="/components/upload/video.php" method="POST" enctype="multipart/form-data">

          <div class="form-group">

              <h1 class="profile-user-name" style="font-size: 2rem;font-weight: 300;color:white;">Publish Your Short Video</h1>

          </div><br>

          <div class="form-group">

            <label for="caption" style="color:white;">Description</label>
            ...
            <textarea type="text" class="form-control mt-2" id="caption" rows="4"  placeholder="What's On Your Mind, <?php echo $_SESSION['username']; ?>?" onchange="get_caption();" name="caption" maxlength="500"></textarea>

          </div><br>

          <div class="form-group">

            <label for="tag-id" style="color:white;">Tags</label>

            <input type="text" class="form-control mt-2" id="tag-id" aria-describedby="caption-area" placeholder="#amarworldontop #harun" onchange="get_hash();" name="hash-tags" maxlength="50">

          </div><br>

          <div class="form-group" id="vid-group">

            <label for="tag-id" style="color:white;">Add video : </label>
          ...
          <div class="form-group">
              ...
              <label for="tag-id" style="color:white;">Add video Thumbnail : </label>
      ...
      <div class="post">
        ...
        <div class="info">
          ...
          <div class="user">
            ...
            <p class="username">Preview short</p>
        ...
        <div class="post-content">
          ...
          <p class="description" id="caption-data">
            ...
            What a lovely day is it!
          </p>

          <p class="post-time" id="current-date">2024/10/29</p>

          <p class="post-time" id="hash-tags" style="color: #3942e7;"><i>#amarworldontop #gg</i></p>
