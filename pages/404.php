    ...
    <main class="main">
        ...
        <section class="home">
            <div class="home-container container">
                <div class="home-data">
                    ...
                    <p class="home-description">
                        We can't find any page.<br>Please click the Home button.
                    </p>
                    <a href="/home" class="home-button">Go Home</a>
                </div>

                <div class="home-img">
                    <img src="https://i.ibb.co.com/PgsFwfR/404-unscreen.gif" alt="">
            ...
            <footer class="home-footer">
                <span> </span>
                <span>support@amarworld.line.pm</span>
            </footer>
        </section>
    </main>
