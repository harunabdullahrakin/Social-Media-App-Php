...
<div class="row py-6 px-4 container"><div class="col-md-11 mx-auto">
            ...
            <div class="px-4 pt-0 pb-4 cover">
                ...
                <div class="media align-items-end profile-head">
                    ...
                    <div class="profile mr-3">
                        ...
                        <img src="<?php echo "../storage/pfp/".$_SESSION['img_path'] ?>"  width="160" style="border-radius: 50%;">
            ...
            <div class="bg-light p-4 d-flex justify-content-end text-center">
                ...
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item"> <h5 class="font-weight-bold mb-0 d-block"><?php echo $_SESSION['fallowers'] ?></h5><small class="text-muted">
                            ...
                            <i class="fas fa-user mr-1""></i><a href="/information" style="text-decoration: none; color: #1c1f23;">Followers</small></a></li>

                    <li class="list-inline-item"> <h5 class="font-weight-bold mb-0 d-block"><?php echo $_SESSION['fallowing'] ?></h5><small class="text-muted">

                            <i class="fas fa-user mr-1"></i><a href="/information" style="text-decoration: none; color: #1c1f23;">Following</small></a></li>
                </ul>
